...
class NotificationChannel extends BaseChannel implements ChannelInterface
{
    public const QUEUE = 'tasks.notifications.queue';
    public const EXCHANGE = 'tasks.notifications';
