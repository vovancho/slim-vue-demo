 ...
 *         @OA\JsonContent(
 *             oneOf={
 *                       @OA\Schema(ref="#/components/schemas/OAuthPassword"),
 *                       @OA\Schema(ref="#/components/schemas/OAuthRefreshToken")
 *                   },
 *             example={"grant_type":"password", "username":"new-user@mail.ru", "password":"secret", "client_id":"app",
 *                      "client_secret":"", "access_type":"offline"}
 *         )
 *     ),
 ...
 *      example={"grant_type":"refresh_token", "client_id":"app", "client_secret":"",
 *               "refresh_token":"def50200c237e058820886407037f..."}
 * )
 *
 * @OA\Schema(
 ...
 *      @OA\Property(property="refresh_token", type="string"),
 *      example={"token_type":"Bearer", "expires_in":3600, "access_token":"eyJ0eXAiOiJKV1QiLOiJSUzI1Ni...",
 *               "refresh_token":"def50200c237e058820886407037f..."}
 * )
 */
