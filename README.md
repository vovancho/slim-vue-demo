...
amqp               | <p><sup>8083 (шлюз) <i>(админка)</i></sup></p><p><sup>5672 </sup></p> |  <p>RabbitMQ сервер *(Очередь для взаимодействия сервисов)* </p><sup><p>Логин/Пароль `rabbit:rabbit`</p></sup>
